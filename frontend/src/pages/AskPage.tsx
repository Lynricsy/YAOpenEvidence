...
export default function AskPage() {
  ...
  const openPaper = (n: number, pid: number | null) => setSearchParams({ paper: String(n), ...(pid !== null ? { pid: String(pid) } : {}) })
