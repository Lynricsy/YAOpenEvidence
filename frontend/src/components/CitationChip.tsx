    ...
    <HoverCard openDelay={200} closeDelay={120}>
      <HoverCardTrigger asChild>
        <button
          ...
          className="mx-0.5 inline-flex h-5 items-center rounded border px-1.5 align-baseline font-mono text-[11px] font-semibold leading-none no-underline"
      ...
      <HoverCardContent
        align="start"
        className="w-[min(420px,calc(100vw-2rem))] space-y-3 text-sm"
      ...
      >
        ...
        {citation ? (
          <>
            ...
            <p className="max-h-56 overflow-y-auto border-l-2 border-primary/25 pl-3 text-xs leading-6">
              <QuoteHighlight
                text={citation.text}
          ...
          citations
            ...
            .slice(0, 3)
            .map((quote, i) => (
              <p className="border-l-2 pl-3 text-xs leading-6" key={i}>
                {quote}
              </p>
            ))
        ) : (
