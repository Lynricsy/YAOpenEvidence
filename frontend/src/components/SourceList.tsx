...
export function SourceList({
  ...
  return (
    <section aria-label="来源" className="min-w-0 border-t pt-6">
      <h2 className="mb-2 text-lg font-semibold">
        来源（{papers.length} 篇，{nFulltext} 篇全文）
      </h2>
      ...
      {unused.length > 0 && (
        <Collapsible className="mt-3 border-t">
          <CollapsibleTrigger className="flex w-full items-center justify-between gap-2 py-4 text-left text-sm text-muted-foreground [&[data-state=open]>svg]:rotate-180">
