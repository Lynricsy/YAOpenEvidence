...
所有运行期产物都挂在 `PICOSEEK_DATA` 下（默认为 core/ 本身，行为与历史一致）；
...
DATA_ROOT = os.environ.get("PICOSEEK_DATA") or CORE_DIR
...
PAYWALL_STATE = os.environ.get("SD_STATE_PATH") or os.path.join(VAR_DIR, "sd_state.json")
