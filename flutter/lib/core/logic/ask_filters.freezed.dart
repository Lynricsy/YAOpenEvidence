...
mixin _$AskFilters {
 ...
 List<int> get quartiles; bool get keepUnranked; YearMode get yearMode; int get years; int? get yearFrom; int? get yearTo; List<String> get journals; int get papers; bool get useKb; int get kbHits; int get maxChars;
...
int get hashCode {
  final _this = this as AskFilters;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.quartiles),_this.keepUnranked,_this.yearMode,_this.years,_this.yearFrom,_this.yearTo,const DeepCollectionEquality().hash(_this.journals),_this.papers,_this.useKb,_this.kbHits,_this.maxChars);
}

@override
String toString() {
  final _this = this as AskFilters;
  return 'AskFilters(quartiles: ${_this.quartiles}, keepUnranked: ${_this.keepUnranked}, yearMode: ${_this.yearMode}, years: ${_this.years}, yearFrom: ${_this.yearFrom}, yearTo: ${_this.yearTo}, journals: ${_this.journals}, papers: ${_this.papers}, useKb: ${_this.useKb}, kbHits: ${_this.kbHits}, maxChars: ${_this.maxChars})';
}
...
@useResult
$Res call({
 List<int> quartiles, bool keepUnranked, YearMode yearMode, int years, int? yearFrom, int? yearTo, List<String> journals, int papers, bool useKb, int kbHits, int maxChars
});
...
/// Create a copy of AskFilters
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? quartiles = null,Object? keepUnranked = null,Object? yearMode = null,Object? years = null,Object? yearFrom = freezed,Object? yearTo = freezed,Object? journals = null,Object? papers = null,Object? useKb = null,Object? kbHits = null,Object? maxChars = null,}) {
  return _then(AskFilters(
quartiles: null == quartiles ? _self.quartiles : quartiles // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<int> quartiles,  bool keepUnranked,  YearMode yearMode,  int years,  int? yearFrom,  int? yearTo,  List<String> journals,  int papers,  bool useKb,  int kbHits,  int maxChars)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AskFilters() when $default != null:
return $default(_that.quartiles,_that.keepUnranked,_that.yearMode,_that.years,_that.yearFrom,_that.yearTo,_that.journals,_that.papers,_that.useKb,_that.kbHits,_that.maxChars);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<int> quartiles,  bool keepUnranked,  YearMode yearMode,  int years,  int? yearFrom,  int? yearTo,  List<String> journals,  int papers,  bool useKb,  int kbHits,  int maxChars)  $default,) {final _that = this;
switch (_that) {
case _AskFilters():
return $default(_that.quartiles,_that.keepUnranked,_that.yearMode,_that.years,_that.yearFrom,_that.yearTo,_that.journals,_that.papers,_that.useKb,_that.kbHits,_that.maxChars);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<int> quartiles,  bool keepUnranked,  YearMode yearMode,  int years,  int? yearFrom,  int? yearTo,  List<String> journals,  int papers,  bool useKb,  int kbHits,  int maxChars)?  $default,) {final _that = this;
switch (_that) {
case _AskFilters() when $default != null:
return $default(_that.quartiles,_that.keepUnranked,_that.yearMode,_that.years,_that.yearFrom,_that.yearTo,_that.journals,_that.papers,_that.useKb,_that.kbHits,_that.maxChars);case _:
  return null;
...
class _AskFilters extends AskFilters {
  const _AskFilters({ List<int> quartiles = const <int>[], this.keepUnranked = false, this.yearMode = YearMode.recent, this.years = 3, this.yearFrom, this.yearTo,  List<String> journals = const <String>[], this.papers = 8, this.useKb = true, this.kbHits = 0, this.maxChars = 28000}): _quartiles = quartiles,_journals = journals,super._();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _AskFilters&&const DeepCollectionEquality().equals(other.quartiles, _quartiles)&&(identical(other.keepUnranked, keepUnranked) || other.keepUnranked == keepUnranked)&&(identical(other.yearMode, yearMode) || other.yearMode == yearMode)&&(identical(other.years, years) || other.years == years)&&(identical(other.yearFrom, yearFrom) || other.yearFrom == yearFrom)&&(identical(other.yearTo, yearTo) || other.yearTo == yearTo)&&const DeepCollectionEquality().equals(other.journals, _journals)&&(identical(other.papers, papers) || other.papers == papers)&&(identical(other.useKb, useKb) || other.useKb == useKb)&&(identical(other.kbHits, kbHits) || other.kbHits == kbHits)&&(identical(other.maxChars, maxChars) || other.maxChars == maxChars));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_quartiles),keepUnranked,yearMode,years,yearFrom,yearTo,const DeepCollectionEquality().hash(_journals),papers,useKb,kbHits,maxChars);
}

@override
String toString() {
    return 'AskFilters(quartiles: $quartiles, keepUnranked: $keepUnranked, yearMode: $yearMode, years: $years, yearFrom: $yearFrom, yearTo: $yearTo, journals: $journals, papers: $papers, useKb: $useKb, kbHits: $kbHits, maxChars: $maxChars)';
}
...
/// Create a copy of AskFilters
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? quartiles = null,Object? keepUnranked = null,Object? yearMode = null,Object? years = null,Object? yearFrom = freezed,Object? yearTo = freezed,Object? journals = null,Object? papers = null,Object? useKb = null,Object? kbHits = null,Object? maxChars = null,}) {
  return _then(_AskFilters(
quartiles: null == quartiles ? _self._quartiles : quartiles // ignore: cast_nullable_to_non_nullable
as List<int>,keepUnranked: null == keepUnranked ? _self.keepUnranked : keepUnranked // ignore: cast_nullable_to_non_nullable
as bool,yearMode: null == yearMode ? _self.yearMode : yearMode // ignore: cast_nullable_to_non_nullable
as YearMode,years: null == years ? _self.years : years // ignore: cast_nullable_to_non_nullable
as int,yearFrom: freezed == yearFrom ? _self.yearFrom : yearFrom // ignore: cast_nullable_to_non_nullable
